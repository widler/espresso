module EViewTest__render__render_partial
  ...
  Spec.new App do
    ...
    Should 'render given file, with layout of :render_given_file action, as `render` method is executed inside :render_given_file action ' do
      expect(get(:render_given_file, 'blah.xml').body) == 'Hello blah.xml.erb!'
    end
